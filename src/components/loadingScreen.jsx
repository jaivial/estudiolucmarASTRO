...
const LoadingScreen = () => (
  <div id="loading-screen" className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-white bg-opacity-100 z-20">
    <svg className="h-[100px] w-auto" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
